...
<style>
    ...
    .orders-page .pagination{gap:6px}.orders-page .pagination .page-item{margin:0}.orders-page .pagination .page-link{background:#0f1524;border:1px solid #283759;color:#7f96bb;border-radius:6px!important;min-width:34px;height:34px;display:inline-flex;justify-content:center;align-items:center;padding:0 10px}.orders-page .pagination .page-item.active .page-link{background:#2358c6;border-color:#2358c6;color:#fff}.orders-page .pagination .page-item.disabled .page-link{background:#0b0f19;color:#3b4b68;border-color:#1c2b4b}.orders-page .pagination .page-link:hover:not(.disabled){background:#1a233a;color:#fff}
